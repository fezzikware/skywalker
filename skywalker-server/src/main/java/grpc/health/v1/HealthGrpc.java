...
public final class HealthGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<grpc.health.v1.HealthCheckService.HealthCheckRequest,
      grpc.health.v1.HealthCheckService.HealthCheckResponse> getCheckMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Check",
      requestType = grpc.health.v1.HealthCheckService.HealthCheckRequest.class,
      responseType = grpc.health.v1.HealthCheckService.HealthCheckResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<grpc.health.v1.HealthCheckService.HealthCheckRequest,
      grpc.health.v1.HealthCheckService.HealthCheckResponse> getCheckMethod() {
    io.grpc.MethodDescriptor<grpc.health.v1.HealthCheckService.HealthCheckRequest, grpc.health.v1.HealthCheckService.HealthCheckResponse> getCheckMethod;
    if ((getCheckMethod = HealthGrpc.getCheckMethod) == null) {
      synchronized (HealthGrpc.class) {
        if ((getCheckMethod = HealthGrpc.getCheckMethod) == null) {
          HealthGrpc.getCheckMethod = getCheckMethod =
              io.grpc.MethodDescriptor.<grpc.health.v1.HealthCheckService.HealthCheckRequest, grpc.health.v1.HealthCheckService.HealthCheckResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Check"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  grpc.health.v1.HealthCheckService.HealthCheckRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  grpc.health.v1.HealthCheckService.HealthCheckResponse.getDefaultInstance()))
  ...
  public static abstract class HealthImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void check(grpc.health.v1.HealthCheckService.HealthCheckRequest request,
        io.grpc.stub.StreamObserver<grpc.health.v1.HealthCheckService.HealthCheckResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                grpc.health.v1.HealthCheckService.HealthCheckRequest,
                grpc.health.v1.HealthCheckService.HealthCheckResponse>(
                  this, METHODID_CHECK)))
          .build();
    }
  }
  ...
  public static final class HealthBlockingStub extends io.grpc.stub.AbstractBlockingStub<HealthBlockingStub> {
    ...
    /**
     */
    public grpc.health.v1.HealthCheckService.HealthCheckResponse check(grpc.health.v1.HealthCheckService.HealthCheckRequest request) {
  ...
  public static final class HealthFutureStub extends io.grpc.stub.AbstractFutureStub<HealthFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<grpc.health.v1.HealthCheckService.HealthCheckResponse> check(
        grpc.health.v1.HealthCheckService.HealthCheckRequest request) {
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_CHECK:
          serviceImpl.check((grpc.health.v1.HealthCheckService.HealthCheckRequest) request,
              (io.grpc.stub.StreamObserver<grpc.health.v1.HealthCheckService.HealthCheckResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class HealthBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return grpc.health.v1.HealthCheckService.getDescriptor();
    }
