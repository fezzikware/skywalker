...
public interface EBPFOffCPUProfilingOrBuilder extends
   ...
   */
  java.util.List<org.apache.skywalking.apm.network.ebpf.profiling.v3.EBPFProfilingStackMetadata> 
      getStacksList();
  /**
   * <pre>
   * stack data in one task(thread)
   ...
   * <code>repeated .skywalking.v3.EBPFProfilingStackMetadata stacks = 1;</code>
   */
  org.apache.skywalking.apm.network.ebpf.profiling.v3.EBPFProfilingStackMetadata getStacks(int index);
  /**
   * <pre>
   * stack data in one task(thread)
   * </pre>
   ...
   * <code>repeated .skywalking.v3.EBPFProfilingStackMetadata stacks = 1;</code>
   */
  java.util.List<? extends org.apache.skywalking.apm.network.ebpf.profiling.v3.EBPFProfilingStackMetadataOrBuilder> 
   ...
   * <code>repeated .skywalking.v3.EBPFProfilingStackMetadata stacks = 1;</code>
   */
  org.apache.skywalking.apm.network.ebpf.profiling.v3.EBPFProfilingStackMetadataOrBuilder getStacksOrBuilder(
      int index);
