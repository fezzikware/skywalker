...
public interface EBPFProfilingDataOrBuilder extends
   ...
   * @return The offCPU.
   */
  org.apache.skywalking.apm.network.ebpf.profiling.v3.EBPFOffCPUProfiling getOffCPU();
  /**
   * <code>.skywalking.v3.EBPFOffCPUProfiling offCPU = 3;</code>
   */
  org.apache.skywalking.apm.network.ebpf.profiling.v3.EBPFOffCPUProfilingOrBuilder getOffCPUOrBuilder();
